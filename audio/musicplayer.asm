...
MusicPlayerPals:
if DEF(NOIR)
	GRAYSCALE 03, 03, 12, 28
	GRAYSCALE 03, 03, 18, 28
	GRAYSCALE 03, 03, 10, 28
	GRAYSCALE 03, 03, 14, 28
elif DEF(MONOCHROME)
rept 4
...
endr
	...
	RGB 02,03,04, 02,03,04, 10,12,14, 26,28,30 ; bg
	RGB 02,03,04, 02,03,04, 06,26,06, 26,28,30 ; green
	RGB 02,03,04, 02,03,04, 07,07,31, 26,28,30 ; blue
	RGB 02,03,04, 02,03,04, 31,07,07, 26,28,30 ; red
endc
...
.loop:
	...
	; TH Adds a blank character to hide the number of the set :) for some reason it's adding 3 in front of the supposed char
	add "'t"
